...
const DEFAULT_CHAT_FRAMES = [
  { id: 'cf-pill-001', name: 'Viên thuốc 1', price: 400, rarity: 'common', shape: 'cf-shape-pill', bg: '#f1cfcf', textColor: '#6e2020', desc: 'Hình dạng tin nhắn: Viên thuốc' },
  { id: 'cf-round-002', name: 'Bo tròn 2', price: 445, rarity: 'common', shape: 'cf-shape-round', bg: '#f1e1cf', textColor: '#6e4a20', desc: 'Hình dạng tin nhắn: Bo tròn' },
  { id: 'cf-soft-003', name: 'Mềm đuôi 3', price: 490, rarity: 'common', shape: 'cf-shape-soft', bg: '#eef1cf', textColor: '#686e20', desc: 'Hình dạng tin nhắn: Mềm đuôi' },
  { id: 'cf-sharp-004', name: 'Vuông 4', price: 535, rarity: 'common', shape: 'cf-shape-sharp', bg: '#dcf1cf', textColor: '#3d6e20', desc: 'Hình dạng tin nhắn: Vuông' },
  { id: 'cf-ticket-005', name: 'Vé 5', price: 580, rarity: 'common', shape: 'cf-shape-ticket', bg: '#cff1d4', textColor: '#206e2c', desc: 'Hình dạng tin nhắn: Vé' },
  { id: 'cf-blob-006', name: 'Blob 6', price: 625, rarity: 'common', shape: 'cf-shape-blob', bg: '#cff1e7', textColor: '#206e57', desc: 'Hình dạng tin nhắn: Blob' },
  { id: 'cf-cloud-007', name: 'Mây 7', price: 670, rarity: 'common', shape: 'cf-shape-cloud', bg: '#cfe9f1', textColor: '#205b6e', desc: 'Hình dạng tin nhắn: Mây' },
  { id: 'cf-heart-008', name: 'Trái tim 8', price: 715, rarity: 'common', shape: 'cf-shape-heart', bg: '#cfd6f1', textColor: '#20316e', desc: 'Hình dạng tin nhắn: Trái tim' },
  { id: 'cf-tail-009', name: 'Bong bóng 9', price: 760, rarity: 'common', shape: 'cf-shape-tail', bg: '#dacff1', textColor: '#39206e', desc: 'Hình dạng tin nhắn: Bong bóng' },
  { id: 'cf-diamond-010', name: 'Kim cương 10', price: 805, rarity: 'common', shape: 'cf-shape-diamond', bg: '#eccff1', textColor: '#63206e', desc: 'Hình dạng tin nhắn: Kim cương' },
  { id: 'cf-wave-011', name: 'Sóng 11', price: 850, rarity: 'common', shape: 'cf-shape-wave', bg: '#f1cfe3', textColor: '#6e204f', desc: 'Hình dạng tin nhắn: Sóng' },
  { id: 'cf-star-012', name: 'Ngôi sao 12', price: 895, rarity: 'common', shape: 'cf-shape-star', bg: '#f1cfd1', textColor: '#6e2024', desc: 'Hình dạng tin nhắn: Ngôi sao' },
  { id: 'cf-double-013', name: 'Viền kép 13', price: 940, rarity: 'common', shape: 'cf-shape-double', bg: '#f1dfcf', textColor: '#6e4520', desc: 'Hình dạng tin nhắn: Viền kép' },
  { id: 'cf-pill-014', name: 'Viên thuốc 14', price: 985, rarity: 'common', shape: 'cf-shape-pill', bg: '#f0f1cf', textColor: '#6d6e20', desc: 'Hình dạng tin nhắn: Viên thuốc' },
  { id: 'cf-round-015', name: 'Bo tròn 15', price: 1030, rarity: 'common', shape: 'cf-shape-round', bg: '#def1cf', textColor: '#426e20', desc: 'Hình dạng tin nhắn: Bo tròn' },
  { id: 'cf-soft-016', name: 'Mềm đuôi 16', price: 1075, rarity: 'common', shape: 'cf-shape-soft', bg: '#cff1d2', textColor: '#206e27', desc: 'Hình dạng tin nhắn: Mềm đuôi' },
  { id: 'cf-sharp-017', name: 'Vuông 17', price: 1120, rarity: 'common', shape: 'cf-shape-sharp', bg: '#cff1e5', textColor: '#206e52', desc: 'Hình dạng tin nhắn: Vuông' },
  { id: 'cf-ticket-018', name: 'Vé 18', price: 1165, rarity: 'common', shape: 'cf-shape-ticket', bg: '#cfebf1', textColor: '#20606e', desc: 'Hình dạng tin nhắn: Vé' },
  { id: 'cf-blob-019', name: 'Blob 19', price: 1210, rarity: 'common', shape: 'cf-shape-blob', bg: '#cfd8f1', textColor: '#20366e', desc: 'Hình dạng tin nhắn: Blob' },
  { id: 'cf-cloud-020', name: 'Mây 20', price: 1255, rarity: 'common', shape: 'cf-shape-cloud', bg: '#d8cff1', textColor: '#34206e', desc: 'Hình dạng tin nhắn: Mây' },
  { id: 'cf-heart-021', name: 'Trái tim 21', price: 1300, rarity: 'common', shape: 'cf-shape-heart', bg: '#eacff1', textColor: '#5e206e', desc: 'Hình dạng tin nhắn: Trái tim' },
  { id: 'cf-tail-022', name: 'Bong bóng 22', price: 1345, rarity: 'common', shape: 'cf-shape-tail', bg: '#f1cfe5', textColor: '#6e2053', desc: 'Hình dạng tin nhắn: Bong bóng' },
  { id: 'cf-diamond-023', name: 'Kim cương 23', price: 1390, rarity: 'common', shape: 'cf-shape-diamond', bg: '#f1cfd3', textColor: '#6e2029', desc: 'Hình dạng tin nhắn: Kim cương' },
  { id: 'cf-wave-024', name: 'Sóng 24', price: 1435, rarity: 'common', shape: 'cf-shape-wave', bg: '#f1ddcf', textColor: '#6e4120', desc: 'Hình dạng tin nhắn: Sóng' },
  { id: 'cf-star-025', name: 'Ngôi sao 25', price: 1480, rarity: 'common', shape: 'cf-shape-star', bg: '#f1efcf', textColor: '#6e6b20', desc: 'Hình dạng tin nhắn: Ngôi sao' },
  { id: 'cf-double-026', name: 'Viền kép 26', price: 1525, rarity: 'common', shape: 'cf-shape-double', bg: '#e0f1cf', textColor: '#476e20', desc: 'Hình dạng tin nhắn: Viền kép' },
  { id: 'cf-pill-027', name: 'Viên thuốc 27', price: 1570, rarity: 'common', shape: 'cf-shape-pill', bg: '#cff1d0', textColor: '#206e23', desc: 'Hình dạng tin nhắn: Viên thuốc' },
  { id: 'cf-round-028', name: 'Bo tròn 28', price: 1615, rarity: 'common', shape: 'cf-shape-round', bg: '#cff1e3', textColor: '#206e4d', desc: 'Hình dạng tin nhắn: Bo tròn' },
  { id: 'cf-soft-029', name: 'Mềm đuôi 29', price: 1660, rarity: 'common', shape: 'cf-shape-soft', bg: '#cfedf1', textColor: '#20656e', desc: 'Hình dạng tin nhắn: Mềm đuôi' },
  { id: 'cf-sharp-030', name: 'Vuông 30', price: 1705, rarity: 'common', shape: 'cf-shape-sharp', bg: '#cfdbf1', textColor: '#203a6e', desc: 'Hình dạng tin nhắn: Vuông' },
  { id: 'cf-ticket-031', name: 'Vé 31', price: 1750, rarity: 'common', shape: 'cf-shape-ticket', bg: '#d6cff1', textColor: '#2f206e', desc: 'Hình dạng tin nhắn: Vé' },
  { id: 'cf-blob-032', name: 'Blob 32', price: 1795, rarity: 'common', shape: 'cf-shape-blob', bg: '#e8cff1', textColor: '#5a206e', desc: 'Hình dạng tin nhắn: Blob' },
  { id: 'cf-cloud-033', name: 'Mây 33', price: 1840, rarity: 'common', shape: 'cf-shape-cloud', bg: '#f1cfe7', textColor: '#6e2058', desc: 'Hình dạng tin nhắn: Mây' },
  { id: 'cf-heart-034', name: 'Trái tim 34', price: 1885, rarity: 'common', shape: 'cf-shape-heart', bg: '#f1cfd5', textColor: '#6e202e', desc: 'Hình dạng tin nhắn: Trái tim' },
  { id: 'cf-tail-035', name: 'Bong bóng 35', price: 1930, rarity: 'common', shape: 'cf-shape-tail', bg: '#f1dbcf', textColor: '#6e3c20', desc: 'Hình dạng tin nhắn: Bong bóng' },
  { id: 'cf-diamond-036', name: 'Kim cương 36', price: 1975, rarity: 'common', shape: 'cf-shape-diamond', bg: '#f1edcf', textColor: '#6e6620', desc: 'Hình dạng tin nhắn: Kim cương' },
  { id: 'cf-wave-037', name: 'Sóng 37', price: 2020, rarity: 'common', shape: 'cf-shape-wave', bg: '#e2f1cf', textColor: '#4c6e20', desc: 'Hình dạng tin nhắn: Sóng' },
  { id: 'cf-star-038', name: 'Ngôi sao 38', price: 2065, rarity: 'common', shape: 'cf-shape-star', bg: '#d0f1cf', textColor: '#216e20', desc: 'Hình dạng tin nhắn: Ngôi sao' },
  { id: 'cf-double-039', name: 'Viền kép 39', price: 2110, rarity: 'common', shape: 'cf-shape-double', bg: '#cff1e1', textColor: '#206e48', desc: 'Hình dạng tin nhắn: Viền kép' },
  { id: 'cf-pill-040', name: 'Viên thuốc 40', price: 2155, rarity: 'common', shape: 'cf-shape-pill', bg: '#cfeff1', textColor: '#20696e', desc: 'Hình dạng tin nhắn: Viên thuốc' },
  { id: 'cf-round-041', name: 'Bo tròn 41', price: 2500, rarity: 'rare', shape: 'cf-shape-round', bg: '#cfddf1', textColor: '#203f6e', desc: 'Hình dạng tin nhắn: Bo tròn' },
  { id: 'cf-soft-042', name: 'Mềm đuôi 42', price: 2545, rarity: 'rare', shape: 'cf-shape-soft', bg: '#d4cff1', textColor: '#2b206e', desc: 'Hình dạng tin nhắn: Mềm đuôi' },
  { id: 'cf-sharp-043', name: 'Vuông 43', price: 2590, rarity: 'rare', shape: 'cf-shape-sharp', bg: '#e6cff1', textColor: '#55206e', desc: 'Hình dạng tin nhắn: Vuông' },
  { id: 'cf-ticket-044', name: 'Vé 44', price: 2635, rarity: 'rare', shape: 'cf-shape-ticket', bg: '#f1cfe9', textColor: '#6e205d', desc: 'Hình dạng tin nhắn: Vé' },
  { id: 'cf-blob-045', name: 'Blob 45', price: 2680, rarity: 'rare', shape: 'cf-shape-blob', bg: '#f1cfd7', textColor: '#6e2032', desc: 'Hình dạng tin nhắn: Blob' },
  { id: 'cf-cloud-046', name: 'Mây 46', price: 2725, rarity: 'rare', shape: 'cf-shape-cloud', bg: '#f1d9cf', textColor: '#6e3720', desc: 'Hình dạng tin nhắn: Mây' },
  { id: 'cf-heart-047', name: 'Trái tim 47', price: 2770, rarity: 'rare', shape: 'cf-shape-heart', bg: '#f1ebcf', textColor: '#6e6220', desc: 'Hình dạng tin nhắn: Trái tim' },
  { id: 'cf-tail-048', name: 'Bong bóng 48', price: 2815, rarity: 'rare', shape: 'cf-shape-tail', bg: '#e4f1cf', textColor: '#506e20', desc: 'Hình dạng tin nhắn: Bong bóng' },
  { id: 'cf-diamond-049', name: 'Kim cương 49', price: 2860, rarity: 'rare', shape: 'cf-shape-diamond', bg: '#d2f1cf', textColor: '#266e20', desc: 'Hình dạng tin nhắn: Kim cương' },
  { id: 'cf-wave-050', name: 'Sóng 50', price: 2905, rarity: 'rare', shape: 'cf-shape-wave', bg: '#cff1df', textColor: '#206e44', desc: 'Hình dạng tin nhắn: Sóng' },
  { id: 'cf-star-051', name: 'Ngôi sao 51', price: 2950, rarity: 'rare', shape: 'cf-shape-star', bg: '#cff1f1', textColor: '#206e6e', desc: 'Hình dạng tin nhắn: Ngôi sao' },
  { id: 'cf-double-052', name: 'Viền kép 52', price: 2995, rarity: 'rare', shape: 'cf-shape-double', bg: '#cfdff1', textColor: '#20446e', desc: 'Hình dạng tin nhắn: Viền kép' },
  { id: 'cf-pill-053', name: 'Viên thuốc 53', price: 3040, rarity: 'rare', shape: 'cf-shape-pill', bg: '#d2cff1', textColor: '#26206e', desc: 'Hình dạng tin nhắn: Viên thuốc' },
  { id: 'cf-round-054', name: 'Bo tròn 54', price: 3085, rarity: 'rare', shape: 'cf-shape-round', bg: '#e4cff1', textColor: '#50206e', desc: 'Hình dạng tin nhắn: Bo tròn' },
  { id: 'cf-soft-055', name: 'Mềm đuôi 55', price: 3130, rarity: 'rare', shape: 'cf-shape-soft', bg: '#f1cfeb', textColor: '#6e2062', desc: 'Hình dạng tin nhắn: Mềm đuôi' },
  { id: 'cf-sharp-056', name: 'Vuông 56', price: 3175, rarity: 'rare', shape: 'cf-shape-sharp', bg: '#f1cfd9', textColor: '#6e2037', desc: 'Hình dạng tin nhắn: Vuông' },
  { id: 'cf-ticket-057', name: 'Vé 57', price: 3220, rarity: 'rare', shape: 'cf-shape-ticket', bg: '#f1d7cf', textColor: '#6e3220', desc: 'Hình dạng tin nhắn: Vé' },
  { id: 'cf-blob-058', name: 'Blob 58', price: 3265, rarity: 'rare', shape: 'cf-shape-blob', bg: '#f1e9cf', textColor: '#6e5d20', desc: 'Hình dạng tin nhắn: Blob' },
  { id: 'cf-cloud-059', name: 'Mây 59', price: 3310, rarity: 'rare', shape: 'cf-shape-cloud', bg: '#e6f1cf', textColor: '#556e20', desc: 'Hình dạng tin nhắn: Mây' },
  { id: 'cf-heart-060', name: 'Trái tim 60', price: 3355, rarity: 'rare', shape: 'cf-shape-heart', bg: '#d4f1cf', textColor: '#2b6e20', desc: 'Hình dạng tin nhắn: Trái tim' },
  { id: 'cf-tail-061', name: 'Bong bóng 61', price: 3400, rarity: 'rare', shape: 'cf-shape-tail', bg: '#cff1dd', textColor: '#206e3f', desc: 'Hình dạng tin nhắn: Bong bóng' },
  { id: 'cf-diamond-062', name: 'Kim cương 62', price: 3445, rarity: 'rare', shape: 'cf-shape-diamond', bg: '#cff1ef', textColor: '#206e69', desc: 'Hình dạng tin nhắn: Kim cương' },
  { id: 'cf-wave-063', name: 'Sóng 63', price: 3490, rarity: 'rare', shape: 'cf-shape-wave', bg: '#cfe1f1', textColor: '#20486e', desc: 'Hình dạng tin nhắn: Sóng' },
  { id: 'cf-star-064', name: 'Ngôi sao 64', price: 3535, rarity: 'rare', shape: 'cf-shape-star', bg: '#d0cff1', textColor: '#21206e', desc: 'Hình dạng tin nhắn: Ngôi sao' },
  { id: 'cf-double-065', name: 'Viền kép 65', price: 3580, rarity: 'rare', shape: 'cf-shape-double', bg: '#e2cff1', textColor: '#4c206e', desc: 'Hình dạng tin nhắn: Viền kép' },
  { id: 'cf-pill-066', name: 'Viên thuốc 66', price: 3625, rarity: 'rare', shape: 'cf-shape-pill', bg: '#f1cfed', textColor: '#6e2066', desc: 'Hình dạng tin nhắn: Viên thuốc' },
  { id: 'cf-round-067', name: 'Bo tròn 67', price: 3670, rarity: 'rare', shape: 'cf-shape-round', bg: '#f1cfdb', textColor: '#6e203c', desc: 'Hình dạng tin nhắn: Bo tròn' },
  { id: 'cf-soft-068', name: 'Mềm đuôi 68', price: 3715, rarity: 'rare', shape: 'cf-shape-soft', bg: '#f1d5cf', textColor: '#6e2e20', desc: 'Hình dạng tin nhắn: Mềm đuôi' },
  { id: 'cf-sharp-069', name: 'Vuông 69', price: 3760, rarity: 'rare', shape: 'cf-shape-sharp', bg: '#f1e7cf', textColor: '#6e5820', desc: 'Hình dạng tin nhắn: Vuông' },
  { id: 'cf-ticket-070', name: 'Vé 70', price: 3805, rarity: 'rare', shape: 'cf-shape-ticket', bg: '#e8f1cf', textColor: '#5a6e20', desc: 'Hình dạng tin nhắn: Vé' },
  { id: 'cf-blob-071', name: 'Blob 71', price: 4350, rarity: 'epic', shape: 'cf-shape-blob', bg: '#d6f1cf', textColor: '#2f6e20', desc: 'Hình dạng tin nhắn: Blob' },
  { id: 'cf-cloud-072', name: 'Mây 72', price: 4395, rarity: 'epic', shape: 'cf-shape-cloud', bg: '#cff1db', textColor: '#206e3a', desc: 'Hình dạng tin nhắn: Mây' },
  { id: 'cf-heart-073', name: 'Trái tim 73', price: 4440, rarity: 'epic', shape: 'cf-shape-heart', bg: '#cff1ed', textColor: '#206e65', desc: 'Hình dạng tin nhắn: Trái tim' },
  { id: 'cf-tail-074', name: 'Bong bóng 74', price: 4485, rarity: 'epic', shape: 'cf-shape-tail', bg: '#cfe3f1', textColor: '#204d6e', desc: 'Hình dạng tin nhắn: Bong bóng' },
  { id: 'cf-diamond-075', name: 'Kim cương 75', price: 4530, rarity: 'epic', shape: 'cf-shape-diamond', bg: '#cfd0f1', textColor: '#20236e', desc: 'Hình dạng tin nhắn: Kim cương' },
  { id: 'cf-wave-076', name: 'Sóng 76', price: 4575, rarity: 'epic', shape: 'cf-shape-wave', bg: '#e0cff1', textColor: '#47206e', desc: 'Hình dạng tin nhắn: Sóng' },
  { id: 'cf-star-077', name: 'Ngôi sao 77', price: 4620, rarity: 'epic', shape: 'cf-shape-star', bg: '#f1cfef', textColor: '#6e206b', desc: 'Hình dạng tin nhắn: Ngôi sao' },
  { id: 'cf-double-078', name: 'Viền kép 78', price: 4665, rarity: 'epic', shape: 'cf-shape-double', bg: '#f1cfdd', textColor: '#6e2041', desc: 'Hình dạng tin nhắn: Viền kép' },
  { id: 'cf-pill-079', name: 'Viên thuốc 79', price: 4710, rarity: 'epic', shape: 'cf-shape-pill', bg: '#f1d3cf', textColor: '#6e2920', desc: 'Hình dạng tin nhắn: Viên thuốc' },
  { id: 'cf-round-080', name: 'Bo tròn 80', price: 4755, rarity: 'epic', shape: 'cf-shape-round', bg: '#f1e5cf', textColor: '#6e5320', desc: 'Hình dạng tin nhắn: Bo tròn' },
  { id: 'cf-soft-081', name: 'Mềm đuôi 81', price: 4800, rarity: 'epic', shape: 'cf-shape-soft', bg: '#eaf1cf', textColor: '#5e6e20', desc: 'Hình dạng tin nhắn: Mềm đuôi' },
  { id: 'cf-sharp-082', name: 'Vuông 82', price: 4845, rarity: 'epic', shape: 'cf-shape-sharp', bg: '#d8f1cf', textColor: '#346e20', desc: 'Hình dạng tin nhắn: Vuông' },
  { id: 'cf-ticket-083', name: 'Vé 83', price: 4890, rarity: 'epic', shape: 'cf-shape-ticket', bg: '#cff1d8', textColor: '#206e36', desc: 'Hình dạng tin nhắn: Vé' },
  { id: 'cf-blob-084', name: 'Blob 84', price: 4935, rarity: 'epic', shape: 'cf-shape-blob', bg: '#cff1eb', textColor: '#206e60', desc: 'Hình dạng tin nhắn: Blob' },
  { id: 'cf-cloud-085', name: 'Mây 85', price: 4980, rarity: 'epic', shape: 'cf-shape-cloud', bg: '#cfe5f1', textColor: '#20526e', desc: 'Hình dạng tin nhắn: Mây' },
  { id: 'cf-heart-086', name: 'Trái tim 86', price: 5025, rarity: 'epic', shape: 'cf-shape-heart', bg: '#cfd2f1', textColor: '#20276e', desc: 'Hình dạng tin nhắn: Trái tim' },
  { id: 'cf-tail-087', name: 'Bong bóng 87', price: 5070, rarity: 'epic', shape: 'cf-shape-tail', bg: '#decff1', textColor: '#42206e', desc: 'Hình dạng tin nhắn: Bong bóng' },
  { id: 'cf-diamond-088', name: 'Kim cương 88', price: 5115, rarity: 'epic', shape: 'cf-shape-diamond', bg: '#f0cff1', textColor: '#6d206e', desc: 'Hình dạng tin nhắn: Kim cương' },
  { id: 'cf-wave-089', name: 'Sóng 89', price: 5160, rarity: 'epic', shape: 'cf-shape-wave', bg: '#f1cfdf', textColor: '#6e2045', desc: 'Hình dạng tin nhắn: Sóng' },
  { id: 'cf-star-090', name: 'Ngôi sao 90', price: 5205, rarity: 'epic', shape: 'cf-shape-star', bg: '#f1d1cf', textColor: '#6e2420', desc: 'Hình dạng tin nhắn: Ngôi sao' },
  { id: 'cf-double-091', name: 'Viền kép 91', price: 6450, rarity: 'legendary', shape: 'cf-shape-double', bg: '#f1e3cf', textColor: '#6e4f20', desc: 'Hình dạng tin nhắn: Viền kép' },
  { id: 'cf-pill-092', name: 'Viên thuốc 92', price: 6495, rarity: 'legendary', shape: 'cf-shape-pill', bg: '#ecf1cf', textColor: '#636e20', desc: 'Hình dạng tin nhắn: Viên thuốc' },
  { id: 'cf-round-093', name: 'Bo tròn 93', price: 6540, rarity: 'legendary', shape: 'cf-shape-round', bg: '#daf1cf', textColor: '#396e20', desc: 'Hình dạng tin nhắn: Bo tròn' },
  { id: 'cf-soft-094', name: 'Mềm đuôi 94', price: 6585, rarity: 'legendary', shape: 'cf-shape-soft', bg: '#cff1d6', textColor: '#206e31', desc: 'Hình dạng tin nhắn: Mềm đuôi' },
  { id: 'cf-sharp-095', name: 'Vuông 95', price: 6630, rarity: 'legendary', shape: 'cf-shape-sharp', bg: '#cff1e9', textColor: '#206e5b', desc: 'Hình dạng tin nhắn: Vuông' },
  { id: 'cf-ticket-096', name: 'Vé 96', price: 6675, rarity: 'legendary', shape: 'cf-shape-ticket', bg: '#cfe7f1', textColor: '#20576e', desc: 'Hình dạng tin nhắn: Vé' },
  { id: 'cf-blob-097', name: 'Blob 97', price: 6720, rarity: 'legendary', shape: 'cf-shape-blob', bg: '#cfd4f1', textColor: '#202c6e', desc: 'Hình dạng tin nhắn: Blob' },
  { id: 'cf-cloud-098', name: 'Mây 98', price: 6765, rarity: 'legendary', shape: 'cf-shape-cloud', bg: '#dccff1', textColor: '#3d206e', desc: 'Hình dạng tin nhắn: Mây' },
  { id: 'cf-heart-099', name: 'Trái tim 99', price: 6810, rarity: 'legendary', shape: 'cf-shape-heart', bg: '#eecff1', textColor: '#68206e', desc: 'Hình dạng tin nhắn: Trái tim' },
  { id: 'cf-tail-100', name: 'Bong bóng 100', price: 6855, rarity: 'legendary', shape: 'cf-shape-tail', bg: '#f1cfe1', textColor: '#6e204a', desc: 'Hình dạng tin nhắn: Bong bóng' }
];
