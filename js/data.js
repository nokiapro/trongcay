...
const DEFAULT_FAIRY_PACKS = [
  { id: 'tien-1', days: 1, price: 200, icon: '🧚', name: 'Tiên 1 ngày' },
  { id: 'tien-3', days: 3, price: 500, icon: '🧚', name: 'Tiên 3 ngày' },
  { id: 'tien-5', days: 5, price: 750, icon: '🧚', name: 'Tiên 5 ngày' },
  { id: 'tien-7', days: 7, price: 1000, icon: '🧚', name: 'Tiên 7 ngày' },
  { id: 'tien-10', days: 10, price: 1300, icon: '🧚', name: 'Tiên 10 ngày' },
  { id: 'tien-15', days: 15, price: 1800, icon: '🧚', name: 'Tiên 15 ngày' },
  { id: 'tien-30', days: 30, price: 3000, icon: '🧚', name: 'Tiên 30 ngày' }
];

/** Gói Người Yêu Cũ — tự thu hoạch + trồng lại theo cấu hình hạt */
const DEFAULT_NYC_PACKS = [
  { id: 'nyc-1', days: 1, price: 250, icon: '💔', name: 'NYC 1 ngày' },
  { id: 'nyc-3', days: 3, price: 650, icon: '💔', name: 'NYC 3 ngày' },
  { id: 'nyc-5', days: 5, price: 950, icon: '💔', name: 'NYC 5 ngày' },
  { id: 'nyc-7', days: 7, price: 1300, icon: '💔', name: 'NYC 7 ngày' },
  { id: 'nyc-10', days: 10, price: 1700, icon: '💔', name: 'NYC 10 ngày' },
  { id: 'nyc-15', days: 15, price: 2400, icon: '💔', name: 'NYC 15 ngày' },
  { id: 'nyc-30', days: 30, price: 4000, icon: '💔', name: 'NYC 30 ngày' }
];
