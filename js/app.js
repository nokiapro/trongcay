  ...
  plots.forEach((plot, i) => {
    ...
    if (!plot.plantId) {
      ...
      if (!plant) {
        ...
        div.innerHTML = `
          <div class="plot-badges"><span class="plot-badge-left">${waterBadge}</span><span class="plot-badge-right">${fertBadge}</span></div>
    ...
    ids.forEach(id => {
      ...
      opt.innerHTML = `
        ...
        <div class="info" style="flex:1;min-width:0">
          ...
          <div class="qty">Còn ${have.toLocaleString()} · ${Game.formatTime(plant.growTime)}</div>
        </div>
