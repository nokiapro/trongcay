...
// ========== CHĂN NUÔI ==========
// feedId: loại cám phù hợp | growTime: giây đến trưởng thành
// productInterval: giây giữa các lần thu sản phẩm | feedPerTime: số cám mỗi lần cho ăn
const DEFAULT_FEEDS = [
  { id: 'cam-trau', icon: '🌾', name: 'Cám trâu (rơm cỏ)', price: 25, desc: 'Rơm + cỏ khô cho trâu.', forTypes: ['trau'] },
  { id: 'cam-bo', icon: '🌿', name: 'Cám bò', price: 30, desc: 'Cỏ + ngũ cốc cho bò sữa.', forTypes: ['bo'] },
  { id: 'cam-lon', icon: '🌽', name: 'Cám lợn', price: 28, desc: 'Ngô + cám gạo cho lợn.', forTypes: ['lon'] },
  { id: 'cam-ga', icon: '🌾', name: 'Cám gà (thóc)', price: 15, desc: 'Thóc + tấm cho gà đẻ trứng.', forTypes: ['ga'] },
  { id: 'cam-cho', icon: '🦴', name: 'Cám chó', price: 35, desc: 'Thức ăn hạt cho chó.', forTypes: ['cho'] },
  { id: 'cam-meo', icon: '🐟', name: 'Cám mèo', price: 32, desc: 'Cá + hạt cho mèo.', forTypes: ['meo'] },
  { id: 'cam-khi', icon: '🍌', name: 'Cám khỉ (trái cây)', price: 40, desc: 'Chuối + trái cây cho khỉ.', forTypes: ['khi'] },
  { id: 'cam-truc', icon: '🎋', name: 'Tre tươi', price: 55, desc: 'Tre non cho gấu trúc.', forTypes: ['truc'] },
  { id: 'cam-rong', icon: '🔥', name: 'Cám rồng (linh thạch)', price: 200, desc: 'Thức ăn huyền thoại cho rồng.', forTypes: ['rong'] }
];
function getFeeds() { return DEFAULT_FEEDS; }
function getFeed(id) { return DEFAULT_FEEDS.find(f => f && f.id === id); }

const DEFAULT_ANIMALS = [
  {
    id: 'trau', icon: '🐃', name: 'Trâu', type: 'trau', buyPrice: 800,
    growTime: 900, feedId: 'cam-trau', feedPerTime: 2,
    productId: 'sua-trau', productName: 'Sữa trâu', productIcon: '🥛',
    productInterval: 480, productYield: 1, sellPrice: 120, productSell: 45, xp: 12,
    desc: 'Khỏe, cho sữa trâu. Ăn cám trâu (rơm cỏ).'
  },
  {
    id: 'bo', icon: '🐮', name: 'Bò', type: 'bo', buyPrice: 1000,
    growTime: 720, feedId: 'cam-bo', feedPerTime: 2,
    productId: 'sua-bo', productName: 'Sữa bò', productIcon: '🥛',
    productInterval: 360, productYield: 2, sellPrice: 150, productSell: 40, xp: 14,
    desc: 'Bò sữa — cho sữa đều. Ăn cám bò.'
  },
  {
    id: 'lon', icon: '🐷', name: 'Lợn', type: 'lon', buyPrice: 600,
    growTime: 600, feedId: 'cam-lon', feedPerTime: 2,
    productId: 'thit-lon', productName: 'Thịt lợn', productIcon: '🥓',
    productInterval: 600, productYield: 1, sellPrice: 100, productSell: 70, xp: 10,
    desc: 'Nuôi lấy thịt. Ăn cám lợn (ngô).'
  },
  {
    id: 'ga', icon: '🐔', name: 'Gà', type: 'ga', buyPrice: 200,
    growTime: 300, feedId: 'cam-ga', feedPerTime: 1,
    productId: 'trung', productName: 'Trứng gà', productIcon: '🥚',
    productInterval: 180, productYield: 1, sellPrice: 40, productSell: 18, xp: 5,
    desc: 'Đẻ trứng nhanh. Ăn cám gà (thóc).'
  },
  {
    id: 'cho', icon: '🐶', name: 'Chó', type: 'cho', buyPrice: 450,
    growTime: 480, feedId: 'cam-cho', feedPerTime: 1,
    productId: 'long-cho', productName: 'Lông chó', productIcon: '🧶',
    productInterval: 420, productYield: 1, sellPrice: 80, productSell: 35, xp: 8,
    desc: 'Trung thành, thỉnh thoảng nhặt lông. Ăn cám chó.'
  },
  {
    id: 'meo', icon: '🐱', name: 'Mèo', type: 'meo', buyPrice: 420,
    growTime: 420, feedId: 'cam-meo', feedPerTime: 1,
    productId: 'long-meo', productName: 'Lông mèo', productIcon: '🧶',
    productInterval: 400, productYield: 1, sellPrice: 75, productSell: 32, xp: 7,
    desc: 'Đáng yêu, cho lông mềm. Ăn cám mèo.'
  },
  {
    id: 'khi', icon: '🐵', name: 'Khỉ', type: 'khi', buyPrice: 700,
    growTime: 540, feedId: 'cam-khi', feedPerTime: 1,
    productId: 'chuoi-khi', productName: 'Chuối khỉ', productIcon: '🍌',
    productInterval: 300, productYield: 2, sellPrice: 110, productSell: 28, xp: 11,
    desc: 'Tinh nghịch, mang chuối về. Ăn cám khỉ (trái cây).'
  },
  {
    id: 'truc', icon: '🐼', name: 'Gấu trúc', type: 'truc', buyPrice: 2500,
    growTime: 1200, feedId: 'cam-truc', feedPerTime: 2,
    productId: 'tre-thu', productName: 'Măng tre', productIcon: '🎋',
    productInterval: 600, productYield: 2, sellPrice: 400, productSell: 90, xp: 25,
    desc: 'Hiếm & dễ thương. Ăn tre tươi.'
  },
  {
    id: 'rong', icon: '🐉', name: 'Rồng', type: 'rong', buyPrice: 15000,
    growTime: 50000, feedId: 'cam-rong', feedPerTime: 3,
    productId: 'vang-rong', productName: 'Vảy rồng', productIcon: '✨',
    productInterval: 1800, productYield: 1, sellPrice: 5000, productSell: 800, xp: 80,
    desc: 'Huyền thoại. Ăn cám rồng (linh thạch). Cho vảy quý.'
  }
];
